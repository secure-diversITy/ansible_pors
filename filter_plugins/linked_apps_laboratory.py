...
def linked_app_list_laboratory(app):
  base_dir=dir_path + '/../inventories/' + 'laboratory' + '/group_vars/'
  eapp={}
  mopp={}
  overalldict={}
  rolepath='apps'
...
class FilterModule(object):
 def filters(self):
   return {'link_app_list_laboratory': linked_app_list_laboratory}

dir_path = os.path.dirname(os.path.realpath(__file__))
mapp=os.listdir(dir_path + "/../roles/apps")
linked_app_list_laboratory(mapp)
